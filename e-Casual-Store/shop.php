       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                 ...
                 <img src="images/1ecom-store-logo.png" alt="e-com-Store Logo" class="hidden-xs">
                 <img src="images/1ecom-store-logo-mobile.png" alt="e-com-Store Logo Mobile" class="visible-xs">
    ...
    ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="row"><!-- row Begin -->
                   ...
                   <div class="row post-list" id='id0'>
                   ...
                   <div class="row post-list" id='id1'>
                   ...
                   <div class="row post-list" id='id2'>
                   ...
                   <div class="row post-list" id='id3'>
                   ...
                   <div class="row post-list" id='id4'>
                   ...
                   <div class="row post-list" id='id5'>
               ...
               <div class ="row col-12">
                 ...
                 <div class="mr-5">
                   ...
                   <div class="form-group">
                     ...
                     <input type ="text" class="form-control" id="title" area-describedbe="emailHelp">
                 ...
                 <button class="btn btn-primary" onclick="addPost()">Add product</button>
               ...
               <div class ="row col-12">
                 <div>
                   ...
                   <div class="form-group">
                     <label for="exampleInputEmail">Product Title</label>
                     <input type ="text" class="form-control" id="title-edit" area-describedbe="emailHelp">

                   </div>
                   <div class="form-group">
                     <label for="exampleInputPassword">Price</label>
                     <textarea type ="password" class="form-control" id="body-edit"></textarea>

                 </div>
                 <button class="btn btn-primary" onclick="updatePost()">Edit product</button>
               </div>
               </div>
